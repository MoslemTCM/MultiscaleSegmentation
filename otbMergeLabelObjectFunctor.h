...
public:
  ...
  inline LabelObjectPointerType operator()(const LabelObjectType * l1, const LabelObjectType * l2) const
  {
    ...
    LineContainerType lines1 = l1->m_LineContainer; // ~~~ GetLineContainer();
    LineContainerType lines2 = l2->m_LineContainer; // ~~~ GetLineContainer();
  ...
  linesOut2.push_back(*lit);
    ...
    resp->CopyAllFrom(l1);
    resp->m_LineContainer= linesOut2; // ~~~ GetLineContainer() = linesOut2;
